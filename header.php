...
<link rel="stylesheet" type="text/css" href="<?php echo get_stylesheet_directory_uri(); ?>/css/style.css?v=10" />
...
<script src="<?php echo get_stylesheet_directory_uri(); ?>/javascripts/script.js?v=4" type="text/javascript"></script>

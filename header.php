...
<link rel="stylesheet" type="text/css" href="<?php echo get_stylesheet_directory_uri(); ?>/css/style.css?v=11" />
...
<script src="<?php echo get_stylesheet_directory_uri(); ?>/javascripts/script.js?v=5" type="text/javascript"></script>
